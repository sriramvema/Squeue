...
class SQueue{
     ...
     ******************************************/
    Node* mergeMIN(Node* node1, Node* node2);
    Node* mergeMAX(Node* node1, Node* node2);
    Post getPost();
    Node* copy(Node* aNode);
    void clear(Node* aNode);
    void printPostsQueue(Node* aNode) const;
    bool findPost(Node* aNode, Post post);
